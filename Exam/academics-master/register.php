                ...
                <div class="col-md-5">
                    ...
                    <form action="register.php" method="POST" enctype="multipart/form-data" >
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" name="full_name" id="username" class="form-control form-control-lg">
                        </div>
                        <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text"  name="mobile" id="username" class="form-control form-control-lg">
                        </div>
                        <div class="col-md-12 form-group">
                            
                            <label for="username">Image</label>
                            <input type="file"  name="image" id="username" class="form-control form-control-lg">
                        </div>
                        <div class="col-md-12 form-group">
